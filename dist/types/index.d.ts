...
export type AdminAction = 'timeout' | 'kick' | 'ban' | 'unban' | 'warn' | 'clear' | 'create_category' | 'create_category_with_channels' | 'create_channel' | 'delete_channel' | 'rename_channel' | 'slowmode' | 'lock_channel' | 'unlock_channel' | 'give_role' | 'remove_role' | 'create_role' | 'server_info' | 'user_info' | 'announce' | 'send_message' | 'embed' | 'reminder' | 'none';
